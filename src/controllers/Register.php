...
if (!$is_username_valid || !$is_password_valid || !$is_repeated_password_valid || !$is_email_valid || !$is_full_name_valid) {
    header('Location: ../views/Register.php?username=' . json_encode($is_username_valid) . '&password=' . json_encode($is_password_valid) . '&repeated_password=' . json_encode($is_repeated_password_valid) . '&email=' . json_encode($is_email_valid) . '&full_name=' . json_encode($is_full_name_valid));
} else {
